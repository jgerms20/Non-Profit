...
const DEFAULT_CANDIDATES = [
  ...
  },
  {
    ...
    acronym: 'DHI',
    pros: ['Agricultural metaphor connects to SC heritage', 'Evocative and memorable', 'Implies growth and cultivation'],
  ...
  {
    id: '6',
    name: 'RISE - SC AI Skills & Education',
    acronym: 'RISE',
    pros: ['Powerful acronym', 'Action-oriented', 'Covers mission completely', 'SC-specific'],
