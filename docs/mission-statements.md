...
SCAiL is a South Carolina organization built by and for the communities it serves — teaching practical AI skills, cultivating local entrepreneurs, and keeping wealth inside the communities that create it.

**Angle:** Centers ownership and belonging. Speaks directly to residents who may distrust outside organizations coming in to "help." Signals that SCAiL is rooted locally, not parachuting in.
**Best used for:** Community meetings, neighborhood outreach, social media, and any context where trust and local identity are the primary concerns.
...
## Notes for Final Selection

- Versions 1 and 5 are the most accessible for cold audiences unfamiliar with SCAiL.
- Versions 2 and 4 carry the most emotional and strategic weight for fundraising contexts.
- Version 3 is strongest when trust and community ownership are the primary message.
- The final official mission statement may combine elements from multiple versions — this document is a working reference, not a final decision.
